...
func (c *factorialClient) Calculate(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (Factorial_CalculateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Factorial_ServiceDesc.Streams[0], "/rpc_factorial.Factorial/Calculate", opts...)
	if err != nil {
		return nil, err
	}
...
var Factorial_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rpc_factorial.Factorial",
	...
	Metadata: "rpc_factorial/proto/factorial.proto",
}
